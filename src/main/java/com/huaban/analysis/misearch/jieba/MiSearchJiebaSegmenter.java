...
import com.huaban.analysis.misearch.jieba.viterbi.FinalSeg;
...
/**
 * Created by sls on 17-6-14.
 */
public class MiSearchJiebaSegmenter {

    private MiSearchWordDictionary wordDict;
    private FinalSeg finalSeg = FinalSeg.getInstance();

    public MiSearchJiebaSegmenter(String path) {
        MiSearchWordDictionary.setDictPath(path);
        wordDict = MiSearchWordDictionary.getInstance();
    }

    public MiSearchJiebaSegmenter() {
        wordDict = MiSearchWordDictionary.getInstance();
