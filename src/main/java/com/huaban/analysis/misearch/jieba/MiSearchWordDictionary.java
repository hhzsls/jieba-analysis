...
public class MiSearchWordDictionary {
    private static final String MAIN_DICT = "/dict.txt";
    private static MiSearchWordDictionary singleton;
    ...
    private MiSearchWordDictionary() {
        this.loadDict();
    }
    ...
    public static MiSearchWordDictionary getInstance() {
        if (singleton == null) {
            synchronized (MiSearchWordDictionary.class) {
                if (singleton == null) {
                    singleton = new MiSearchWordDictionary();
                    return singleton;
                }
            }
        }
    ...
    public void loadDict() {
        ...
        try {
            ...
            if (DICT_PATH == null || DICT_PATH == "")
                br = new BufferedReader(new InputStreamReader(is, Charset.forName("UTF-8")));
            else {
                System.out.println("initialize optimize main dict:" + DICT_PATH);
                br = Files.newBufferedReader(Paths.get(DICT_PATH), Charset.forName("UTF-8"));
            }
